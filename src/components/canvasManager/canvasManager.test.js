...
describe('Canvas Manager component', () => {
    ...
    let trackImageOnload = () => {
        ...
        Object.defineProperty(Image.prototype, 'applyFilters', () => { });
    }
    ...
    beforeEach(() => {
        state = {
            ...
            filters: { blur: { isOn: true, intensity: 0.33 }, sepia: { isOn: false, intensity: 0.00 }, vintage: { isOn: false } }
        };
